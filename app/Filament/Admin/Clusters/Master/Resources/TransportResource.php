...
use App\Filament\Admin\Clusters\Master\Resources\TransportResource\Pages;
use App\Filament\Admin\Clusters\Master\Resources\TransportResource\RelationManagers;
...
class TransportResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('nama_transport')
                    ->required()
                    ->maxLength(100),
                Forms\Components\TextInput::make('kode_transport')
                    ->required()
                    ->maxLength(50),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('nama_transport')
                    ->searchable(),
                Tables\Columns\TextColumn::make('kode_transport')
                    ->searchable(),
